...
#                 vowel.
#   zh + en       the spans fish.audio reported while synthesizing, saved next
...
# writing the ja tracks alone, which would silently drop 50 of the 78.
import argparse
import json
import os
import re
...
def main() -> None:
    ...
    lines_out = [
        ...
        '// speedScale, the localised zh and en clips carry the spans fish.audio',
        '// reported while synthesizing them (see the script for why that survives',
        '// stage 2).',
