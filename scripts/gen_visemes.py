...
LINES = [
    ...
    # --- Laughter set (shared by every locale) ---
    # Head-pat giggles. Laughter has no language, so these ship ONE pool with
    # no -en twins (avatarVoice.ts exempts the cue from the -en mapping).
