...
$ npx vitest run /Users/charles/portfolio/scripts/avatar/springsim.derive.test.ts -t refuses a body whose skinned meshes it cannot address by name
 ...
 ❯ scripts/avatar/springsim.derive.test.ts (6 tests | 1 failed | 5 skipped) 35ms
...
[…]
whose skinned meshes it cannot address by name 34ms
 ...
 Test Files  1 failed (1)
   ...
   Start at  03:17:52
   Duration  573ms (transform 83ms, setup 42ms, collect 124ms, tests 35ms, environment 258ms, prepare 30ms)
⎯⎯⎯⎯⎯⎯⎯ Failed Tests 1 ⎯⎯⎯⎯⎯⎯⎯
...
[31m+ Received:[39m 
undefined
 ❯ scripts/avatar/springsim.derive.test.ts:129:44
    127|     const shared = first.name as string
    128|     second.name = shared
    129|     expect(() => deriveManifest(twoAlike)).toThrowError(new RegExp(sha…
       |                                            ^
    130| 
    131|     const nameless = glbOf(MODEL)
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯[1/1]⎯
```
...
$ npx vitest run /Users/charles/portfolio/scripts/avatar/springsim.derive.test.ts -t refuses a body whose skinned meshes it cannot address by name
 RUN  v3.2.6 /Users/charles/portfolio
 ❯ scripts/avatar/springsim.derive.test.ts (6 tests | 1 failed | 5 skipped) 33ms
   ↓ parts read off the file, for a body no build wrote a manifest for > calls moving hair hair, and calls nothing else hair
   ↓ parts read off the file, for a body no build wrote a manifest for > puts every skinned primitive somewhere, so the crown still sees the whole body
   ↓ parts read off the file, for a body no build wrote a manifest for > names one Face and one Body_Ski
[…]
ot address by name 33ms
     → expected [Function] to throw an error
   ↓ parts read off the file, for a body no build wrote a manifest for > puts the waist within a hand of where the build measured it
 Test Files  1 failed (1)
      Tests  1 failed | 5 skipped (6)
   Start at  03:17:53
   Duration  440ms (transform 77ms, setup 25ms, collect 118ms, tests 33ms, environment 151ms, prepare 28ms)
⎯⎯⎯⎯⎯⎯⎯ Failed Tests 1 ⎯⎯⎯⎯⎯⎯⎯
 FAIL  scripts/avatar/springsim.derive.test.ts > parts read off the file, for a body no build wrote a manifest for > refuses a body whose skinned meshes it cannot address by name
AssertionError: expected [Function] to throw an error
[32m- Expected:[39m 
...
[31m+ Received:[39m 
undefined
 ❯ scripts/avatar/springsim.derive.test.ts:134:44
    132|     const anon = nameless.json.nodes.filter((n) => n.mesh !== undefine…
    133|     delete nameless.json.meshes[anon.mesh as number].name
    134|     expect(() => deriveManifest(nameless)).toThrowError(/沒有名字/)
       |                                            ^
    135|   })
    136| 
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯[1/1]⎯
...
live preview config > offers every procedural gesture exposed by the avatar handle
 ...
 Test Files  1 failed (1)
   ...
   Start at  03:17:54
   Duration  397ms (transform 67ms, setup 25ms, collect 108ms, tests 5ms, environment 151ms, prepare 26ms)
⎯⎯⎯⎯⎯⎯⎯ Failed Tests 1 ⎯⎯⎯⎯⎯⎯⎯
...
Received: [31m"/[7mx[27m.vrm"[39m
 ❯ scripts/avatar/live-preview.test.ts:62:28
     60|                        'avatar/relative.vrm']) {
     61|       const got = resolvePreviewModel(`?model=${encodeURIComponent(bad…
     62|       expect(got.url, bad).toBe(MIKA_MILFY_MODEL_URL)
       |                            ^
     63|       expect(got.problem, bad).toContain(bad)
     64|     }
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯[1/1]⎯
```
...
$ npx vitest run /Users/charles/portfolio/src/components/chat/clearance.test.ts -t refuses a pan that its own rounding puts outside the range
 RUN  v3.2.6 /Users/charles/portfolio
 ❯ src/components/chat/clearance.test.ts (6 tests | 1 failed | 5 skipped) 5ms
 ...
 Test Files  1 failed (1)
      Tests  1 failed | 5 skipped (6)
   Start at  03:17:54
   Duration  351ms (transform 41ms, setup 25ms, collect 63ms, tests 5ms, environment 151ms, prepare 26ms)
⎯⎯⎯⎯⎯⎯⎯ Failed Tests 1 ⎯⎯⎯⎯⎯⎯⎯
...
$ npx vitest run /Users/charles/portfolio/src/components/chat/clearance.test.ts -t measures the pan against the fov the file was produced under
 ...
 Test Files  1 failed (1)
      Tests  1 failed | 5 skipped (6)
   Start at  03:17:55
   Duration  347ms (transform 42ms, setup 24ms, collect 64ms, tests 3ms, environment 149ms, prepare 27ms)
⎯⎯⎯⎯⎯⎯⎯ Failed Tests 1 ⎯⎯⎯⎯⎯⎯⎯
...
$ npx vitest run /Users/charles/portfolio/scripts/avatar/springsim.derive.test.ts -t names one Face and one Body_Skin
 RUN  v3.2.6 /Users/charles/portfolio
 ❯ scripts/avatar/springsim.derive.test.ts (6 tests | 1 failed | 5 skipped) 7ms
   ↓ parts read off the file, for a body no build wrote a manifest for > calls moving hair hair, and calls nothing else hair
   ↓ parts read off the file, for a body no build wrote a manifest for > puts every skinned primitive somewhere, so the crown still sees the whole body
   × parts read off the file, for a body no build wrote a manifest for > names one Face and one Body_Skin
[…]
inned meshes it cannot address by name
   ↓ parts read off the file, for a body no build wrote a manifest for > puts the waist within a hand of where the build measured it
 Test Files  1 failed (1)
      Tests  1 failed | 5 skipped (6)
   Start at  03:17:56
   Duration  401ms (transform 72ms, setup 24ms, collect 110ms, tests 7ms, environment 149ms, prepare 26ms)
⎯⎯⎯⎯⎯⎯⎯ Failed Tests 1 ⎯⎯⎯⎯⎯⎯⎯
