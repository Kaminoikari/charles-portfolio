...
`pierce-0909.log`。隔日兩件事把它降到 147 px、0.98 倍：gate 多一個條件先讓同一幀
變成 5.03 倍，再切掉衣服底下看不到的身體，見 [cover-0910](cover-0910.md) 與
[pierce-0910](pierce-0910.md)。下面那組距離量測因此不再是唯一能講的話，但它量的仍是這次權重
修正本身的風險，兩者不互相取代。
