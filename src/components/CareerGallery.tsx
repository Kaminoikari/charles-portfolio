...
// Returns the year span ('2022 – 2024'), an open-ended span ('2024 – PRESENT'
// when the range still says PRESENT), or a single year when the role starts and
// ends in the same year. Locale-independent: every dateRange uses these tokens.
