  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-20 select-none" aria-label="Understand What I Do">
        <span
          ref={textLeftRef}
          className="pointer-events-auto absolute right-[calc(50%-10%)] top-[40%] text-4xl leading-[2.25rem] tracking-tight md:right-[calc(50%+80px)] md:top-[37%] md:text-[5rem] md:leading-[5rem] lg:right-[calc(50%+120px)]"
        ...
        <span
          ref={textRightRef}
          className="pointer-events-auto absolute left-[calc(50%-10%)] top-[54%] text-4xl leading-[2.25rem] tracking-tight md:left-[calc(50%+80px)] md:top-[53%] md:text-[5rem] md:leading-[5rem] lg:left-[calc(50%+120px)]"
          onMouseEnter={handleTextEnter}
          onMouseLeave={handleTextLeave}
          style={{
