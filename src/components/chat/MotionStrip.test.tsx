...
// Mika's family, the one the default body belongs to. Other families may drop
// a clip (vroid-sakurada-fumiriya excludes `dance`, though no visitor can pick
// that body); what the strip shows for them is ChatWidget's business, pinned in
// ChatWidget.test.tsx.
