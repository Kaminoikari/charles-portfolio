...
// as `vivi` and not offered to visitors.
//
...
const DECISIONS: ClearanceDecisions = {
  ...
  // before offering `vivi`: measure it the way the recipe says and replace
  // both fields.
  crownFringe: 0.0015,
  crownFringeMeasured:
  ...
  // This body's resting hair sits at 1.4122.
  pans: {
    peaceSign: { waistUp: -0.26 },
    modelPose: { waistUp: -0.23 },
    spin: { waistUp: -0.24 },
    dance: { waistUp: -0.23 },
  },
  ...
  waivers: {
    ...
    dance: { handInHead: 0.26, hipsDrift: 0.13, endWrist: 1.07 },
    idleLoop: { hipsDrift: 0.14 },
  },
