...
const en: Strings = {
  ...
  about: {
    metaTitle: 'About Charles Chen — Head of Product & AI Product Builder in Taiwan',
    metaDescription: 'About Charles Chen (陳德潁), Head of Product at USPACE and an AI Product Manager / AI Product Builder from Taiwan. Product philosophy, AI tooling approach, full career history, and skill set.',
    back: '← BACK TO PORTFOLIO',
    heading: 'About Charles Chen',
    subheading: 'Head of Product at USPACE. AI Product Manager and AI Product Builder from Taiwan.',
    photoAlt: 'Charles Chen — Head of Product',
  ...
  chat: {
    ...
    retry: 'Retry',
    suggested1: 'How were you built?',
    suggested2: 'How does he use AI in his work?',
    suggested3: 'What makes him different as an AI PM?',
