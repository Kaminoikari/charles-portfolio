...
const zhTW: Strings = {
  ...
  about: {
    metaTitle: '關於陳德潁（Charles Chen）— 台灣 Head of Product 與 AI Product Builder',
    metaDescription: '關於陳德潁（Charles Chen），USPACE Head of Product，來自台灣的 AI Product Manager 與 AI Product Builder。產品哲學、AI 工具運用、完整職涯經歷、技能組合。',
    back: '← 返回作品集',
    heading: '關於 Charles Chen',
    subheading: 'USPACE Head of Product。來自台灣的 AI Product Manager 與 AI Product Builder。',
    photoAlt: '陳德潁 — Head of Product',
    sectionWhoIAm: '關於我',
  ...
  chat: {
    ...
    expandAriaLabel: '放大到全螢幕',
    collapseAriaLabel: '離開全螢幕',
    suggestionsTitle: '試著問',
    pipelineTitle: '檢索管線',
    ...
    nodeConverse: '讀取對話',
    nodeRetrieve: '向量檢索',
    nodeGradeDocuments: '文件評分',
    nodeRewriteQuery: '查詢改寫',
    nodeGenerate: '生成回答',
    nodeFallback: '婉拒回答',
    clearLabel: '清除這段對話',
    ...
    retry: '重試',
    suggested1: '你是怎麼被打造出來的?',
    suggested2: '他在工作上怎麼運用 AI?',
    suggested3: '他作為 AI PM 的獨特之處是什麼?',
    suggested4: '他如何做產品決策?',
    suggested5: '他在 USPACE 做了什麼?',
    suggested6: '為什麼團隊該錄取他?',
    motionsLabel: '動作',
    motionsAriaLabel: '播放一個動作',
    motions: {
      dance: '跳舞',
      peaceSign: '比耶',
      modelPose: '擺姿勢',
