...
const zhTW: Strings = {
  ...
  home: {
    ...
    aboutMarker: '[ ABOUT ]',
    aboutHeading: '我能交付什麼。',
    aboutBody1: '我幫助企業把產品願景變成可上線的成果——從推出觸及百萬用戶的行動 App，到從零打造 B2B SaaS。目前在 USPACE 推動 AI 驅動的原型開發，比傳統流程快 5 倍交付。',
    aboutBody2: '不論是擴展 consumer platform、推出企業級產品、或把 AI 整合進開發流程——我帶來能落地的策略、執行力，以及跨部門領導。',
    aboutReadMore: '閱讀更多',
  ...
  about: {
    ...
    philosophyIntro: '我相信最好的產品經理都是 builder。「我們該打造什麼」與「這裡有一個可運作的原型」之間的距離，正是大多數產品點子消亡的地方。用 AI 驅動的開發跨過這道鴻溝後，我能用幾小時、而不是幾週來驗證假設。',
    aiIntro: 'AI 對我來說不是一個加進產品裡的功能——它是我打造產品的方式。我的 AI 驅動工作流貫穿整個產品生命週期：',
  },
  changelog: {
