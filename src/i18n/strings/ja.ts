...
const ja: Strings = {
  ...
  chat: {
    ...
    retry: '再試行',
    suggested1: 'Product Playbook について教えて',
    suggested2: 'どうやって作られたの?',
    suggested3: 'プロダクトの意思決定はどう進める?',
    suggested4: '仕事で AI をどう活用していますか?',
    suggested5: 'なぜチームは彼を採用すべき?',
    suggested6: 'AI PM としての彼の強みは?',
    suggested7: 'USPACE で何をしましたか?',
    muteMusic: 'BGM をミュート',
    unmuteMusic: 'BGM を再生',
  },
  defaults: {
