...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      `她比較安靜的那些小動作沒有變：歪頭、四處張望、換重心、小跳一下、扭腰、低頭看地板，還有你摸她頭頂時的開心搖頭。那些只動頭和脊椎，本來就沒有手臂可以出錯。動作的 credit 放在網站頁尾，跟她的聲音 credit 並排，這是授權要求的。`,
    ],
  },
  {
    id: 'mika-full-height',
  ...
  },
  {
    ...
    body: [
      ...
      `在她頭頂來回輕撫幾下，她會開心地小幅搖頭（安靜地搖；只有真正點她才會出聲）。放著她不管，大約每五秒她會從十六種小動作裡隨機挑一種表演。其中八種是會停住幾秒的姿勢：雙手比 YA、單手在臉旁比 YA、戳自己的臉頰、敬禮、指向你、雙手抱頭、單手插腰，以及插著腰揮手。另外八種比較安靜：歪頭、快速張望、端詳手掌、挪重心、小彈跳、撥頭髮、扭扭腰、低頭看地板。`,
    ...
    body: [
      ...
      { kind: 'heading', text: `代價是什麼，誰可以豁免` },
      {
        ...
        items: [
          ...
          `她現在也有聲音了：24 句日文短句（VOICEVOX:春日部つむぎ 配音，頁尾有標注）涵蓋八種時刻，首次開啟的自我介紹、點她打招呼、打字送出時應答、進全螢幕、點建議問題、關閉時道別、回答完收尾、出錯時認錯，說話期間嘴型會跟著動（沿用回答時的口型迴圈，不做音訊分析）。語音第一下點擊就會出聲（全站背景音樂開關已同步移除），而且每句都只在訪客自己的點按裡播放，不會自己冒出聲音。英文版網站她會用同一把聲音講片假名英語，日式口音是刻意保留的萌點。每次造訪第一次打開聊天室她會完整自我介紹一次，之後就只講短句。`,
        ],
      },
