...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      '網站角落的「與 AI 聊聊」按鈕，會開啟一個我從頭到尾親手設計與打造的聊天機器人。它能用英文、中文、日文回答關於我工作的問題，而且只根據我真實的作品集資料作答，所以不會亂編。我把它做成一件能實際運作的 AI 工程作品，而不是 ChatGPT 的薄包裝。',
      { kind: 'heading', text: '它怎麼回答問題' },
      '它用的是 RAG（檢索增強生成）：不是靠語言模型「記得」什麼，而是先從我的作品集查出相關事實，再根據這些事實寫答案。我這套更進一步是「會自我修正」的 RAG：它會檢查自己的回答：',
      {
        kind: 'list',
        items: [
