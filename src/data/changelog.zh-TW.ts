...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      `這些表演原本落在一張約 27px 高的臉上，手機更只剩 19px。鏡頭現在改取腰上景：臉放大 **1.7 倍**，她在頁面上佔的位置完全沒變，所以其他東西都不必讓位。打開聊天後她還會再大一些，畫布本身變大並以原生解析度渲染，面板態與全螢幕態皆是如此。全螢幕的側欄裡，畫布加高的同時鏡頭同步後拉，所以她在螢幕上的大小完全不變，站位往上移，腿也露到膝蓋以下。下緣的裁切以漸層柔和地溶入頁面。`,
