...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `這些表演原本落在一張約 27px 高的臉上，手機更只剩 19px。鏡頭現在改取腰上景：臉放大 **1.7 倍**，她在頁面上佔的位置完全沒變，所以其他東西都不必讓位。打開聊天後她還會再大一些，畫布本身變大並以原生解析度渲染，面板態與全螢幕態皆是如此。全螢幕的側欄裡，畫布加高的同時鏡頭同步後拉，所以她在螢幕上的大小完全不變，站位往上移，腿也露到膝蓋以下。下緣的裁切以漸層柔和地溶入頁面。畫面也放寬到容得下她的手臂：伸懶腰的指尖原本會被畫布邊緣切掉，現在三種擺放各自多了水平空間。視野角度是垂直計算的，所以這些空間完全不改變她看起來的大小。`,
  ...
  },
  {
    ...
    tags: ['feature', 'design', 'technical'],
    body: [
      `右下角的 AI 助理現在有臉、有身體、也有名字：**Mika 醬**，一個全身 **3D 角色**，她本人就是啟動鈕，手機和桌機都看得到。她會即時反映對話狀態：沒事的時候左顧右盼；你一開始打字，她就上下點頭像在跟著你的草稿；答案串流進來時，嘴巴跟著母音口型開合，全身色調往本站的 mars orange 暖化，回答結束再緩緩恢復原色。在比手機寬的視窗開全螢幕時，她站在檢索管線側欄的底部，一邊「唸」答案、一邊看節點逐一亮起。`,
