...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      `她的中文語音以前並不存在。繁中站的訪客聽到的是未翻譯的日文原檔，英文站聽到的則是用片假名拼寫的英文，那是 VOICEVOX 唯一做得到的事，因為它沒有非日文的音素。現在三個語系各有自己的 24 句錄音，而且講的都是同一把聲音。`,
      ...
      `不過時間戳描述的是文字，文字跟聲音在頭尾會分家：四分之一的語音在最後一個字「結束」之後還響了最多 415 毫秒，還有兩句的開頭是沒有母音可對的鼻音（英文的 Mm、中文的嗯），嘴巴因此慢了將近半秒才動。所以每個檔的第一個與最後一個嘴型，改成釘在音訊本身量出來的起訖時刻上。48 個檔現在的開嘴與閉嘴，都落在她真正發出聲音的那一刻的一毫秒內。`,
      {
        kind: 'stats',
        items: [
          { value: '48', label: `新錄的語音` },
          { value: '0ms', label: `換音色造成的時間偏移` },
          { value: '3', label: `語系，同一把聲音` },
        ],
      },
      `笑聲沒有動。摸頭時的那三段えへへ不含任何語言，三個語系照舊共用同樣的檔案。`,
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      `在她頭頂來回輕撫幾下，她會開心地小幅搖頭，還會害羞地笑一聲。說話仍然只保留給真正點她的時候。放著她不管，大約每五秒她會從十六種小動作裡隨機挑一種表演。其中八種是會停住幾秒的姿勢：雙手比 YA、單手在臉旁比 YA、戳自己的臉頰、敬禮、指向你、雙手抱頭、單手插腰，以及插著腰揮手。另外八種比較安靜：歪頭、快速張望、端詳手掌、挪重心、小彈跳、撥頭髮、扭扭腰、低頭看地板。`,
    ...
    body: [
      ...
      { kind: 'heading', text: `代價是什麼，誰可以豁免` },
      {
        ...
        items: [
          ...
          `她現在也有聲音了：24 句日文短句（VOICEVOX:春日部つむぎ 配音）涵蓋八種時刻，首次開啟的自我介紹、點她打招呼、打字送出時應答、進全螢幕、點建議問題、關閉時道別、回答完收尾、出錯時認錯，說話期間嘴型會跟著動（沿用回答時的口型迴圈，不做音訊分析）。另外還有三段只有笑聲的短音檔，留給摸頭。語音第一下點擊就會出聲（全站背景音樂開關已同步移除），而且她發出的每個聲音都是在回應訪客剛剛做的動作，不會自己冒出聲音。英文版網站她會用同一把聲音講片假名英語，日式口音是刻意保留的萌點。笑聲沒有語言，所以三個語系聽到的是同樣那三段。每次造訪第一次打開聊天室她會完整自我介紹一次，之後就只講短句。`,
        ],
      },
