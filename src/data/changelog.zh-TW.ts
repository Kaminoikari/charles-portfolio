...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `她的顯示區域現在直接等於聊天面板的高度，寬度也照同樣比例放大，所以她揮手需要的左右空間，放大之後還在。`,
      `取景沒有變，一樣是從腰以上，只是整體放大 **1.64 倍**。`,
      `程式裡面板高度和她的高度讀的是同一個數字。之後如果有人把面板調高，她會跟著長高，不會被漏掉。`,
      ...
      `她的大小取兩個數字裡比較小的那一個：面板的高度，或是視窗寬度容得下的高度。比例是固定的，所以窄視窗看到的是同一個位置上小一號的 Mika，每個手勢還是完整在框內。`,
