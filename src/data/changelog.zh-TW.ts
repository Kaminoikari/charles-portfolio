...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `在她頭頂來回輕撫幾下，她會開心地小幅搖頭（安靜地搖；只有真正點她才會出聲）。放著她不管，大約每五秒她會從十八種小動作裡隨機挑一種表演：雙手比 YA、單手在臉旁比 YA、戳自己的臉頰、敬禮、指向你、雙手抱頭、單手插腰，以及插著腰揮手。另外十種比較安靜：歪頭、快速張望、端詳手掌、挪重心、小彈跳、擺動雙臂、撥頭髮、深呼吸、扭扭腰、低頭看地板。`,
