    ...
    body: [
      ...
      `盤點之後，有三個地方是壞的：`,
      {
        ...
        items: [
          ...
          `你打字說 hi，她自稱「作品集小助手」；你點她，語音說的卻是「我是 Mika！」`,
      ...
      `所以三種語言各有一組看得出來的標記：中文收在句尾助詞（喔、啦、欸）跟疊詞，日文用常體、開頭是語氣詞，英文全部縮寫、一個子句講完。164 條開場句與 171 條結尾句照這個標準重寫過，中間的內容一個字都沒動。`,
      { kind: 'heading', text: `怎麼確保它不會再壞掉` },
      `每一件都有測試釘住，然後把修好的地方逐一重新弄壞，確認那些測試真的會變紅。連測試註解裡引用的數字本身也寫成斷言，過期的數字會讓建置失敗，不會留在那裡誤導下一個讀的人。`,
      {
        kind: 'stats',
        items: [
