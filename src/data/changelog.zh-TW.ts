...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      `右下角的 AI 助理現在有臉也有身體：一個全身 **3D 角色**站在啟動鈕上方，手機和桌機都看得到。她會即時反映對話狀態：沒事的時候左顧右盼；你一開始打字，她就上下點頭像在跟著你的草稿；答案串流進來時，嘴巴跟著母音口型開合，全身色調往本站的 mars orange 暖化，回答結束再緩緩恢復原色。`,
      ...
      { kind: 'heading', text: `代價是什麼，誰可以豁免` },
      {
        ...
        items: [
          ...
          `膠囊仍是真正的無障礙按鈕（focus ring、aria-label、鍵盤路徑不變）；角色是裝飾，點她也能開啟。`,
          `手機上她站在啟動鈕上方；聊天面板蓋住窄螢幕時她整個讓開，渲染同步暫停。`,
        ],
      },
