...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      `右下角的 AI 助理現在有臉也有身體：一個全身 **3D 角色**，她本人就是啟動鈕，手機和桌機都看得到。她會即時反映對話狀態：沒事的時候左顧右盼；你一開始打字，她就上下點頭像在跟著你的草稿；答案串流進來時，嘴巴跟著母音口型開合，全身色調往本站的 mars orange 暖化，回答結束再緩緩恢復原色。在桌面尺寸的視窗開全螢幕時，她站在檢索管線側欄的底部，一邊「唸」答案、一邊看節點逐一亮起。`,
