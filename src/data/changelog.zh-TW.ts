...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      `登場隔天，**Mika** 學會了表演。她的嘴型現在逐音節貼合語音，臉上有真實的情緒起伏，會揮手打招呼、鞠躬道別，還會注意到你的游標。整批升級同時讓她的下載量**輕了 64%**。`,
      ...
      { kind: 'heading', text: `她會注意到你` },
      `桌機上，游標靠近時她會看著它，離開後視線回到平常的左右張望。在她頭頂來回輕撫幾下，她會開心地小幅搖頭（安靜地搖；只有真正點她才會出聲）。放著她不管，大約每五秒她會從十一種小動作裡隨機挑一種表演：伸懶腰、歪頭、快速張望、端詳手掌、挪重心、小彈跳、擺動雙臂、撥頭髮、深呼吸、扭扭腰，或低頭看地板。`,
