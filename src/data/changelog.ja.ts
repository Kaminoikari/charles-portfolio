...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      'トップページのオープニングは、私自身の顔の 3D ポートレートになりました。three.js と WebGL でブラウザ内にリアルタイム描画し、従来の Canvas 2D パーティクルヒーローを置き換えています。Enter を押すと走査線が顔をなぞり、ハーフトーンの点群をライティングされたワイヤーフレームへと変え、また元へ戻します。機械が人を見分ける前に、まず観察するように。',
