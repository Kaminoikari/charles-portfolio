    ...
    body: [
      ...
      { kind: 'heading', text: `コストと、免除される訪問者` },
      {
        ...
        items: [
          ...
          `キャラクター自身が起動ボタンです。aria-label とキーボード操作はそのまま引き継ぎ、focus ring は足元のグローリングに置き換えました。初回訪問時には吹き出しが 8 秒だけタップを誘い、その後は姿を消します。モデルのダウンロード中（および対象外の訪問者、読み込み失敗時）は従来のカプセル型ボタンが代役を務めます。`,
