...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      `三つの言語それぞれに、見分けのつく目印を決めました。中国語は文末の語気助詞と繰り返し、日本語は常体と冒頭の感動詞、英語は短縮形と一文一節。この基準で冒頭文 164 本と結びの一文 171 本を書き直しました。あいだの内容に手を入れたのは日本語の二段落だけで、どちらも前述の「私」を「あたし」に直したものです。`,
