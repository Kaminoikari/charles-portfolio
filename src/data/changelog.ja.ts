...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      `静かなしぐさはそのままです。首をかしげる、あたりを見回す、重心を移す、小さく跳ねる、腰をひねる、床を覗き込む、そして頭を撫でられたときの嬉しそうな揺れ。どれも頭と背骨だけを動かすので、もともと間違えようのある腕がありません。アニメーションのクレジットはライセンスの求めに従い、声のクレジットと並べてサイトのフッターに置いてあります。`,
    ],
  },
  {
    id: 'mika-full-height',
  ...
  },
  {
    ...
    body: [
      ...
      `頭の上を何度か往復してなでると、うれしそうに小さく頭を揺らします（静かに。声を出すのは実際にタップしたときだけ）。放っておくと、およそ 5 秒ごとに 16 種類の小さなしぐさからランダムにひとつ披露します。8 種は数秒とめて見せるポーズで、両手でピース、顔の横で片手ピース、自分のほっぺをつつく、敬礼、こちらを指さす、頭の後ろで手を組む、片手を腰に当てる、腰に手を当てたまま手を振る。残りの 8 種は、首かしげ、あたりを見回す、手のひらを眺める、重心移動、小さなバウンス、髪に触れる、腰ひねり、足元をのぞき込む、です。`,
