...
export const changelog: ChangelogEntry[] = [
  {
    ...
    date: '2026-06-18',
    title: 'AI チャットボットがブログ記事を全文読めるようになりました',
    ...
    body: [
      ...
      { kind: 'heading', text: '変更点' },
      {
        ...
        items: [
          ...
          '**言語を意識したチャンク分割**:依存関係ゼロの再帰的スプリッターが長文を重なりのある段落に分割し、英語だけでなく中国語の文末(。!?)も適切に扱います。',
          '**設計から多言語対応**:記事は中国語で書かれていますが、多言語埋め込みにより英語や日本語の質問でも取得でき、より深い答えがどの言語でも表に出てきます。',
        ],
      },
    ],
  },
