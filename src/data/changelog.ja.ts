    ...
    body: [
      ...
      { kind: 'heading', text: `コストと、免除される訪問者` },
      {
        ...
        items: [
          ...
          `声もつきました。タップすると挨拶し、質問を送ると短く応えます（VOICEVOX:春日部つむぎ、クレジットはフッターに記載）。話しているあいだは口も動きます（回答時と同じ口形ループで、音声解析はしません）。音声は最初のタップからそのまま鳴ります（サイト全体の BGM スイッチは同時に廃止しました）。再生されるのは訪問者自身のタップの中だけで、勝手に鳴り出すことはありません。`,
        ],
      },
