...
export const changelog: ChangelogEntry[] = [
  {
    ...
    date: '2026-09-25',
    title: `見た目の切り替えで十三人のキャラクターを選べるようになりました`,
    tags: ['feature', 'technical'],
    body: [
      `入力欄の上の見た目ストリップには、これまで Mika の三つの見た目だけが並んでいました。今は十三人です。彼女の三つに加えて、今月初めにすべてのモーションで計測を済ませたまま載せていなかった VRoid キャラクター十人が加わりました。タップするとその場で入れ替わり、動きは最初の三つと同じです。十人はすべて女性キャラクターで、同時に計測した男性キャラクター三人は載せていません。`,
      { kind: 'heading', text: `背の高いキャラクターも頭が画面に収まります` },
      `全画面表示の上端は Mika の髪の 25mm 上に合わせてあり、カメラが上がるのはクリップ再生中だけでした。新しいキャラクターのうち八人は Mika より背が高く、そのうち三人は立っているだけで頭頂が上端からはみ出していました。今は静止時のカメラが、それぞれのキャラクター自身の頭上に Mika と同じ余白を取ります。クリップ再生中もその高さより下がりません。Mika 自身の構図は変わっていません。`,
      `確認のため、新しいキャラクター全員に両方の表示ですべてのクリップを再生し、毎フレームでキャンバス最上部の二行を読み取りました。静止時にはみ出すものはありません。再生中に残る最大のものは、一人のダンスの頂点で見える頭頂の細い一線です。`,
      {
        kind: 'stats',
        items: [
          { value: '13', label: `選べる見た目` },
          { value: '10', label: `新しいキャラクター` },
          { value: '0', label: `静止時に切れる頭` },
        ],
      },
    ],
  },
  {
    id: 'mika-look-switch',
    date: '2026-09-03',
    title: `Mika の見た目を切り替えられるようになり、選んだ方をサイトが覚えます`,
    tags: ['feature', 'technical'],
    body: [
      `Mika の見た目は三つになりました。ずっと着ていたピンク髪の塗り直し版、Blender のパイプラインから出てきたツインテールの再現版、そして出発点になった紫髪の VRoid 原版です。どれが表示されるかは、これまでコード内の定数でした。入力欄の上の小さな列に三つとも並び、タップするとその場で入れ替わります。`,
      `再現版はこのリストの中でいちばん面白い一体です。同じ 54 本のボーンの上に載った別のメッシュで、髪も髪飾りも衣装も Blender でモデリングしてあり、ほかの二つは同じ書き出しのテクスチャ塗り直しです。骨格が同じであることが、三つとも 10 本のモーションクリップをそのまま流用できる理由です。`,
      { kind: 'heading', text: `切り替えで実際に起きること` },
      `VRM は体・顔・髪・服を一つのファイルに焼き込むので、衣装が違えばファイルも違います。エンジンは新しいファイルをバックグラウンドで取得し、その間いまの体は待機を続けます。解析が終わると 1 フレームで新しい体を装着し、materialize の登場演出をもう一度再生するので、彼女が改めて現れたように見えます。10 本のモーションクリップは解析済みのソースから新しい骨に結び直すため再ダウンロードは発生せず、表情とリップシンクも二つの体が同じ blendshape 名を持つのでそのまま引き継がれます。`,
      `初回ロードとその後の切り替えは、同じコードパスを通るようになりました。これが今回の主なエンジニアリング判断です。切り替え専用の処理を別に書くと、誰かが片方に初期化手順を足してもう片方を忘れた瞬間から二つはずれ始め、体をロードできるテストが存在しないため誰も気づけません。`,
      { kind: 'heading', text: `細かいけれど効くところ` },
      {
        kind: 'list',
        items: [
          `チップにホバーやフォーカスすると、その体をブラウザキャッシュに温めておきます。タップした時点で残るのは解析だけです。`,
          `体が到着するまで、列のチップはすべて無効になります。ダウンロード中の二度目のタップは、意味を失ったダウンロードをもう一つ積むだけだからです。`,
          `切り替えに失敗したら、彼女は元の体のままで、選択は体のある側に戻り、何も記憶しません。`,
          `選択はこのブラウザに記憶されます。ただし実際にロードに成功した場合だけです。\`?mika=base\` 付きのリンクはその体で開き、この記憶には触れません。`,
          `登録表にある体はすべて、ファイルを直接読むテストによって同じリグと同じ表情名に固定されているので、骨の位置が動いたバリアントは登録できません。`,
        ],
      },
      {
        kind: 'stats',
        items: [
          { value: '3', label: `選べる体` },
          { value: '1', label: `初回ロードと切り替えが共有するロードパス` },
          { value: '34', label: `追加したテスト` },
        ],
      },
    ],
  },
  {
    ...
    date: '2026-08-27',
    title: `ミカの中国語をギャル語域へ、ルールを二つ譲りました`,
    tags: ['design'],
    body: [
      `前回は彼女の性格をシステムに書き込みました。今回はオーナー本人がセリフを書き直しています。よくある質問 57 件の中国語回答をすべて手書きで書き直し、キャラクターの方向を渋谷ギャル＋面倒見のいいお姉さんに定めました。`,
      `おもしろいのはその先です。新しい設定を書いた瞬間、前回の設定を守っていた機械チェックとぶつかりました。`,
      { kind: 'heading', text: `文末の波線` },
      `新しい設定は、文の終わりに「～」を適度に置いて口語的な動きを出すことを求めます。ところがガードは、彼女の締めの一文が文末助詞で終わることを要求していて、助詞の後ろに付いた「～」は助詞なしと判定されました。`,
      `この制限には理由がありました。緩めると「哪一層想問都可以喔～，我告訴你它為什麼在那裡啦！」のような一文が二つのチェックをすり抜け、キャラクターの物真似のように読めてしまいます。その後もう一方のチェックが「～」まで読むよう広げられ、穴はふさがりました。ただ最初の一方を緩め直す人がいなかっただけです。今回それを緩め、その一文が今も弾かれることを確認しました。`,
      { kind: 'heading', text: `絵文字は最大ひとつから、ゼロへ` },
      `旧ルールは一回の返答につき最大ひとつを許し、二つの場面を名指しで残していました。乗っ取りをかわす時と、私的な質問を本人に渡す時です。そこでは温度そのものが中身だからでした。新しい設定は絵文字をレッドラインに置いたので、その二つからも消えました。`,
      `判断の根拠は、訪問者にはどの層が答えたか分からないことです。「はい」と打てば固定のあいさつが返り、次にプロジェクトを聞けばモデルが書きます。同じキャラクターに二つの顔が付くわけです。温度は言葉そのものが担い、新しい語域はもともと旧版より熱を持っています。`,
      { kind: 'heading', text: `笑い声は助詞になりません` },
      `締めの一文で助詞の後ろにさらに「嘻嘻！」を足したものが八件ありました（例：「…喔～嘻嘻！」）。「嘻嘻」は締めのルールを満たせず、新しい設定はもともと「嘻嘻～」を冒頭のあいさつとして挙げています。そこでその八件は笑い声を行頭へ移しました。ほかに五件は文中で助詞を重ねていたので、それぞれ独立した文にしました。`,
      {
        kind: 'stats',
        items: [
          { value: '57', label: `件の中国語回答を手書きで刷新` },
          { value: '16', label: `箇所をガード通過のため調整` },
          { value: '9', label: `個の絵文字を削除` },
        ],
      },
    ],
  },
  {
    id: 'mika-persona',
    date: '2026-08-26',
    title: `ミカに性格ができ、声と文章がようやく同じ人になりました`,
    tags: ['feature', 'design'],
    body: [
      `ミカにはずっと二つの話し方がありました。タップしたとき、質問を送ったとき、パネルを全画面にしたときに聞こえるのは、元気いっぱいの女の子です。「チャールズのこと、あたしが一番くわしいよ！」ところが文章で答えるときの口調は完全に中立で、しかも「Charles のポートフォリオアシスタントです」と名乗っていました。同じキャラクターなのに、しゃべるときと書くときで別人だったわけです。`,
      `今回、彼女の性格を書き下ろし、返答を生み出すすべての経路が同じ定義を読むようにしました。`,
      { kind: 'heading', text: `まず棚卸し：口調はどこから来ているのか` },
      `返答が生まれる場所をすべて洗い出したところ、十層ありました。そのうち AI モデルを通るのは一部だけです。`,
      `この区別が重要です。AI への指示を書き換えても、届くのはモデルを通る層だけだからです。あいさつ、乗っ取りを試された時の切り返し、そして事前に書かれた 57 件のよくある質問への回答は、用意された文字をそのままお渡ししていて、モデルは一切関与しません。`,
      `棚卸しの結果、壊れている箇所が三つ見つかりました：`,
      {
        kind: 'list',
        items: [
          `「さっき何を聞いたっけ」と尋ねると別のコードが引き継ぐのですが、そこには自分がミカだと一度も伝えられておらず、名前のないアシスタントに戻ってしまっていました。`,
          `文字で hi と打つと「ポートフォリオアシスタント」と名乗るのに、タップすると音声は「あたしミカ！」と言います。`,
          `57 件のよくある質問のうち、彼女の視点で書かれていたのは 4 件だけでした。`,
        ],
      },
      { kind: 'heading', text: `彼女はどういう人か` },
      `性格は見た目と釣り合っている必要があるので、まず姿から確認しました。紫黒のグラデーションのロングヘアに青緑のメッシュ、赤と青のクロスピン、星のヘアアクセ、黒いレザーチョーカー、ネイビーのサテンスタジャン。地雷系と原宿ギャルを掛け合わせた路線で、声もこの方向に合わせて選ばれていました。`,
      `つまり方向性ははっきりしています。**彼女は Charles の一番のファンであり、マネージャーであり、本人が照れて言えないことを代わりに言う役です。**`,
      `この設定は、ポートフォリオサイトの古い難題も一緒に解いてくれます。このサイトを見にくるのは主に採用側で、本人が「自分のプロダクトは 700 万人以上に届いた」と言うと自慢に聞こえます。彼女が言えば成立します。しかも彼女の回答が正確かどうか自体が、このサイトが見せているものです。`,
      { kind: 'heading', text: `なぜ可愛いだけではいけないのか` },
      `AI に「もっと可愛くしゃべって」と指示するだけだと、その代償は信頼性に跳ね返ります。採用担当が求めているのは情報の密度です。`,
      `そこで性格は層に分けました。彼女の声は回答の冒頭と末尾にだけ出て、中身はこれまで通り、太字のキーワード、箇条書き、数字はすべてそのままです。`,
      {
        kind: 'table',
        columns: [`場面`, `濃度`, `見え方`],
        rows: [
          [`あいさつ、別れ、攻撃のいなし`, `100%`, `完全にキャラクターとして`],
          [`自分は誰か、どう作られたか`, `70%`, `冒頭の自己紹介に口調、技術の中身は厳密なまま`],
          [`経歴、プロジェクト、スキル`, `20%`, `最初と最後の一文だけ口調、間はブリーフィング体`],
          [`お断り、本人へのご案内`, `40%`, `品位を優先し、口調は控えめに`],
        ],
      },
      `逆向きのルールもあります。絵文字は一回の返答につき最大ひとつ。ポートフォリオに載っていないことを伝えるときは絵文字なしで正直に。甘えた自己卑下は禁止（「あたし、わかんない」のような言い方は採用側の信頼を一瞬で壊します）。そして出典のルールとお断りのルールは、常に口調より優先されます。`,
      { kind: 'heading', text: `日本語で踏んだ二つの落とし穴` },
      `三言語の台詞はそれぞれ書き下ろしています。音声収録のときと同じやり方で、この語感は翻訳では渡らないからです。`,
      `日本語には問題が二つあり、三回続けて踏んでからようやく取り切れました。`,
      `一つ目は、日本語が主語を自由に省けることです。「その詳細はポートフォリオに記載がありません」という文には「あたし」が一度も要りません。その結果、彼女の日本語はサイトを紹介するナレーションのように読めていました。さらに、省かれた主語は直前に話した人にくっつきます。彼のプロジェクトについて「自分のために作ったツール」と書くと、ミカが作ったことになってしまうのです。今は、主語を省くと別の人の話になってしまう箇所で主語を明示し、自称も、名乗っている収録音声と同じ「あたし」に統一しています。`,
      `二つ目は文体です。最初は「説明は敬体で着地させるもの」と判断し、彼女自身の冒頭文まで敬体で書いてしまい、その一文だけ礼儀正しい別人のように読めていました。日本語の収録台詞 25 本はすべて常体なので、今のルールはこうです。彼女自身の最初と最後の一文は必ず常体、あいだの説明は敬体のまま、文体の切り替わりは「彼女が話し終えて資料が始まる」位置にぴったり落ちる。読む人が感じ取れる線です。`,
      { kind: 'heading', text: `書いた一文と、話した一文` },
      `最初の版の口調の一文は、どれも短く、どれも一人称で、テストもすべて通っていました。それでも読むと違う。文法が書き言葉だったからです。収録音声はすべて話し言葉です。「この質問、あたし一番好きなんです」は文章です。収録で彼女が言っているのは「お、それ聞いちゃう？」のほうです。そこで判断基準を収録音声そのものに置きました。各言語 25 本はこのキャラクターが実際に声を持っている唯一の場所で、それに合わない文字は別のキャラクターだからです。`,
      `三つの言語それぞれに、見分けのつく目印を決めました。中国語は文末の語気助詞と繰り返し、日本語は常体と冒頭の感動詞、英語は短縮形と一文一節。この基準で冒頭文 164 本と結びの一文 171 本を書き直しました。あいだの内容に手を入れたのは日本語の三段落だけで、いずれも前述の「私」を「あたし」に直したものです。`,
      `モデルを一切通らない文が、ほかに三つあります。キャラクターの横に出る吹き出し、パネルを開いたときの誘い文、そしてリクエストが失敗したときに彼女のメッセージへ差し込まれる文です。三つともレビューで見つかりました。そこでパネル内のすべての文言に、彼女の発話か、訪問者が投げる質問か、インターフェースの表示かを明示することにしました。印のない文言はテストが赤くなります。`,
      { kind: 'heading', text: `二度と壊れないようにする` },
      `以上はすべてテストで固定し、直した箇所をひとつずつ再び壊して、そのテストが本当に赤くなることを確認しました。テストのコメントが引用している数字自体も assert にしてあるので、古くなった数字はテストを落とします。次に読む人を誤解させたまま残りません。`,
      {
        kind: 'stats',
        items: [
          { value: '10', label: `口調を生む層` },
          { value: '57', label: `件のキャッシュ回答を調律` },
          { value: '3', label: `言語をそれぞれ書き下ろし` },
        ],
      },
    ],
  },
  {
    ...
    date: '2026-08-21',
    title: `ミカが中国語と英語でも話すようになり、三つの言語とも同じ声になりました`,
    tags: ['feature', 'technical'],
    body: [
      `これまでサイトを中国語や英語に切り替えてミカに話させても、聞こえてくるのは日本語でした。中国語サイトでは翻訳していない日本語のクリップがそのまま流れ、英語サイトでは英語の単語をいったんカタカナに置き換えてから読んでいたため、あまり英語には聞こえません。これは当時の音声ソフト VOICEVOX の限界で、出せる音が日本語の音だけだったからです。今回、中国語と英語をそれぞれ 25 句ずつ録音しました。もとの日本語と合わせて三つの言語が自分の台詞を持ち、しかもどれも同じ人の声に聞こえます。`,
      { kind: 'heading', text: `最初の方法：AI に彼女の声を真似させて中国語を読ませる` },
      `考え方は単純でした。ある人の録音を聞かせると、その声を真似できるようになる AI があります。多言語も話せます。そこでミカの日本語の録音を渡し、彼女の声で中国語を読ませてみました。`,
      `結果は使えないものでした。中国語には強い日本語なまりが残り、英語はさらにひどく、ほとんど聞き取れません。`,
      `最初は設定の問題だと思っていましたが、原因は別のところにありました。AI に渡した録音がすべて日本語だったのです。この声が中国語の音をどう出すのかを AI は一度も聞いたことがなく、日本語の音で代用するしかありません。確かめるために声真似の工程を外し、同じ AI に既定の声で同じ中国語を読ませたところ、ごく普通に読めました。原因は参照した録音のほうにありました。`,
      { kind: 'heading', text: `採用した方法：先に別の人に正しく読んでもらい、あとから声を差し替える` },
      `最終的に、一つの台詞を二段階に分けて作ることにしました。`,
      `一段階目は、台湾中国語のネイティブ音声に台詞を読んでもらう工程です。ここで発音と抑揚が決まります。読み上げた内容は正しいのですが、声は他人のままです。`,
      `二段階目で voice conversion をかけ、その録音の声色をミカのものに置き換えます。voice conversion が変えるのは「誰の声に聞こえるか」だけで、「何をどう発音したか」には触れません。だから一段階目で整えた発音がそのまま残ります。`,
      {
        kind: 'table',
        columns: [`段階`, `処理`, `得られるもの`],
        rows: [
          ['1', `ネイティブ音声で合成し、同時にタイムスタンプを取得`, `正しい発音`],
          ['2', `voice conversion`, `彼女の声`],
          ['3', `タイムスタンプを口形タイムラインへ`, `フレーム精度のリップシンク`],
          ['4', `24kHz AAC へエンコード`, `既存クリップと同一規格`],
        ],
      },
      { kind: 'heading', text: `ソフトを替えても、リップシンクは合うのか` },
      `ミカの口の動きはあらかじめ計算してあります。用意したタイムラインを 1 コマずつ音声に合わせる方式です。その元データは VOICEVOX が出していました。音声を合成するときに、どの母音が何秒目に来るかを一緒に報告してくれるのです。`,
      `VOICEVOX を外せば、このデータも一緒に失われるはずでした。ところが新しいツールも同じ情報を返してくれます。中国語は音節ごと、英語は単語ごとです。`,
      `もう一つ、先に確認すべきことがありました。二段階目で音の長さが変わってしまうと、タイムライン全体がずれてしまいます。変換の前後で全ファイルを実測したところ、長さは完全に同じでした。変換前に取った時間は、変換後も同じ音節を指しています。`,
      `ただしタイムラインが表しているのは「文字」であり、文字の始まりと終わりは、音声の始まりと終わりとは一致しません。`,
      `四分の一のクリップでは、最後の文字を読み終えたあとも音が鳴り続けており、長いもので 415 ミリ秒ありました。ほかに二句は冒頭が鼻音で、英語は Mm、中国語は嗯です。鼻音には対応する口の形がないため、口が動き出すまで 0.5 秒近くかかっていました。`,
      `そこで各クリップの最初と最後の口形は、基準を文字の時間から音声そのものの開始点・終了点へ移しました。50 本すべてで、口の開閉と実際に声が出ている瞬間との差は 1000 分の 1 秒以内に収まっています。`,
      {
        kind: 'stats',
        items: [
          { value: '50', label: `新規録音` },
          { value: '0ms', label: `変換による時間のずれ` },
          { value: '3', label: `言語、声はひとつ` },
        ],
      },
      `笑い声は変えていません。頭をなでたときの三つの「えへへ」には言葉が含まれないので、三つのサイトが同じファイルを再生します。例外は三回続けてなでたときで、ここでは彼女が文句を言います。文句は言葉なので、三つの言語それぞれに一句録りました。`,
    ],
  },
  {
    id: 'mika-motion-capture',
    date: '2026-08-19',
    title: `ミカのしぐさをモーションキャプチャーに変え、公開前に全ポーズをプログラムが計測します`,
    tags: ['feature', 'technical'],
    body: [
      `ミカの腕のしぐさ 10 個は、関節の角度を一つずつ手で打ち込んで作ったもので、出来を判断する方法はスクリーンショットを見ることだけでした。今回、各しぐさを彼女の実際の骨格に当てはめ、手が最終的にどこへ行くのかを計算するプログラムを書きました。`,
      `すると 10 個のうち 7 個で、手が名前の言う場所にありませんでした。「髪に触れる」というしぐさで、手は腰の高さに止まっていました。自分の頬をつつくはずのしぐさでは、指先が顔の内側に入っていました。ピースサインでは両方の手のひらが外を向き、見えるのは手の甲だけでした。`,
      `この 10 個はすべて外しました。`,
      { kind: 'heading', text: `なぜ今まで気づけなかったのか` },
      `あのしぐさたちにあった自動チェックは一つだけで、腕を横に広げたときに画面の幅を超えないかを見るものでした。`,
      `手がどこで止まるか、手のひらがどちらを向くか、指が顔を貫通しないか。これらはプログラムからは見えず、人がスクリーンショットを見て判断するしかありません。`,
      `この方法には気づきにくい落とし穴があります。一つのしぐさは多数のコマでできています。見ているコマでポーズを直しても、同じ調整が別のコマを壊してしまい、そのコマを見ないまま進んでしまうのです。`,
      {
        kind: 'table',
        columns: [`しぐさ`, `名前が語ること`, `実測`],
        rows: [
          ['`hairTouch`', `髪に触れる`, `手首は腰の位置で止まり、頭の中心から 0.567m`],
          ['`cheekPoke`', `自分の頬をつつく`, `指先は頭の中心から 0.090m、半径 0.115m の頭蓋の内側`],
          ['`doublePeace`', `両手のピースサイン`, `両方の手のひらが背を向け、見えるのは手の甲`],
          ['`salute`', `敬礼`, `手首が髪に埋まり、指は天井を指す`],
          ['`hipWave`', `腰に手を当てて振る`, `手のひらがカメラと平行で、手の側面しか見えない`],
        ],
      },
      { kind: 'heading', text: `モーションキャプチャーへ、ただし検査を通ってから` },
      `いま彼女が演じている 3 つの動きは、VRoid Project 公式のモーションキャプチャーファイルです。顔の横で構えるピースサイン、静かな立ちポーズ、その場で一回転。モーションキャプチャーとは、実際に人が動いたときの関節の動きを記録し、それをキャラクターに当てはめる方式です。だからもともと関節どうしが噛み合っています。`,
      `同じ公式パックのうち 4 本は、こちらの検査で止まりました。公式のアセットであっても、計測を免除されることはありません。`,
      {
        kind: 'list',
        items: [
          '`greeting`：腰が立位より 0.57m 低い位置から始まるため、最初の 4 秒は床から浮き上がってくる動きになります。6 秒あたりでは指先が頬を通り抜けます。',
          '`shoot`：これはあと一歩で公開されるところでした。こちらへ向けるフィンガーガンはきれいに見え、検査も通り、公開待ちに入っていました。その後、計測範囲を人差し指の先から手の 16 関節すべてに広げたところ、親指が 4 分の 1 秒ほど頬に 5mm ほど食い込んでいることがわかりました。人差し指だけで測ると 1.19 で合格、手全体で測ると 0.90 で不合格です。',
          '`showFullBody`：腕が横に 0.713m 伸びて画面の外まで出てしまい、しかも最後まで手のひらをこちらに向けません。',
          '`squat`：腰が 0.218m 下がり、画面の下端近くまで沈みます。',
        ],
      },
      { kind: 'heading', text: `検査プログラムが実際に測っているもの` },
      `この検査はモデルファイルを直接読んで骨格を組み直し、すべての関節の座標を数学で求めます。ブラウザは開かず、画面も描かないので、全クリップの全コマを測っても 1 秒ほどで終わります。`,
      `確認するのは 6 つです。両手のどの関節も顔の内側に入らないこと。身体全体が実際に見えている画角に収まること。手が主役のしぐさなら、どこかで手のひらをこちらに向けること。腰の高さが立位から 0.08m を超えて離れないこと。クリップの最初と最後で自分の足で立っていること。そして骨格そのものが、直立した身体として組み直せること。`,
      `最後の項目があるのは、こちらの読み込みコードの不具合を実際に捕まえたからです。3 本のうち 1 本はボーンの既定の向きが異なり、普通に読み込むと彼女が逆立ちしてしまいます。`,
      `厄介なのは、その姿勢でも残り 5 つの検査がすべて通ってしまったことです。二つ折りの身体は細く低く、手のひらもどこか特定の方向を向かないため、たまたますべての条件を満たしてしまいます。`,
      `そのため、どの検査も信頼する前に、その検査が捕まえるはずのものをわざと壊し、ちゃんと失敗することを確かめています。壊し方は項目ごとに違います。弾いたクリップを戻せば多くの検査がそれぞれの欠陥を捕まえますが、直立の検査はデコード処理を外したときにだけ失敗します。目の前に出てくるクリップの後ろには、必ず合格した計測結果があります。`,
      {
        kind: 'stats',
        items: [
          { value: '7 / 10', label: `計測で壊れていた旧・腕のしぐさ` },
          { value: '3', label: `検査を通って公開されたクリップ` },
          { value: '6', label: `全クリップが通るべき検査` },
        ],
      },
      `静かなしぐさは変えていません。首をかしげる、あたりを見回す、重心を移す、小さく跳ねる、腰をひねる、床を覗き込む、頭をなでられたときの嬉しそうな揺れ。どれも頭と背骨しか動かさないので、そもそも間違えようのある腕がありません。`,
    ],
  },
  {
    id: 'mika-full-height',
    date: '2026-08-14',
    title: `ミカが大きくなり、チャットウィンドウと同じ高さになりました`,
    tags: ['design', 'technical'],
    body: [
      `これまでチャットを開くと、560px のパネルの隣に 342px のミカが立っていました。隣のパネルよりずいぶん背が低く、話し相手というより隅に置かれた飾りに見える大きさでした。`,
      `いまは二つのチャットサイズのどちらでも高さいっぱいに立ちます。小さいウィンドウでは隣のパネルと同じ高さ、全画面では画面の高さそのものです。`,
      { kind: 'heading', text: `小さいウィンドウ：パネルと同じ高さにする` },
      `表示領域はチャットパネルより高くなっています。上げた手が伸びる先として、カメラが髪の上に余白を残しているからです。その余白はいまパネルの上端より外へはみ出しているので、パネルとそろうのは彼女自身です。髪の先がパネルの上端に届き、身体はそのまま下端まで伸びます。`,
      `幅も同じ比率で広がるので、しぐさに必要な左右の余白は拡大後も残ります。`,
      `構図は変えておらず、腰から上のままです。単に大きく描かれていて、隅のボタンでいるときの約 **2.7 倍**になります。`,
      `コード上、彼女の大きさはパネルの高さから計算されます。今後パネルを高くすれば彼女も一緒に伸びるので、置き去りになることはありません。`,
      { kind: 'heading', text: `全画面：彼女専用の一列` },
      `全画面ではこれまで左側の 236px のレールの下に置かれ、高さは 400px までという制限がありました。その結果、拡大したばかりの小さいウィンドウより全画面のほうが小さいという、妙なことになっていました。`,
      `いまは対話の右側に移り、ヘッダーから下のパネル全体の高さを使えます。`,
      `ここに一つ、説明しておきたい工夫があります。テキストを押しのけるのは彼女の身体だけで、表示領域の残りは透明なまま、しぐさが振り抜けるための余白として空けてあります。この透明な部分はテキストの隣の隙間に浮いているだけで、場所を取りません。`,
      `もし手を抜いて、表示領域の幅ぶんの列を切り出していたら、読む領域は **132px** 狭くなっていました。`,
      `カメラも構図を取り直しました。以前の構図は髪の上に余白が残っていて、400px の絵ではほとんど気になりませんが、800px に拡大すると目立つ空白になります。`,
      `上端を頭のすぐ上まで下げ、下端は膝のままにしたので、同じ領域の中で以前より **10% 大きく**映ります。`,
      { kind: 'heading', text: `ウィンドウが狭いときは、小さくなりますが場所は変わりません` },
      `どれだけ幅を詰めても、彼女が別の場所へ飛ぶことはありません。`,
      `サイズは二つの数値のうち小さいほうを採ります。パネルの高さと、ウィンドウの幅で許される高さです。彼女はパネルに合わせるので、背の低いウィンドウではパネル自体が低くなり、彼女もその分だけ低くなります。変わったのは、背の低さが二度目の代償を取らなくなったことです。以前は上げた手のための余白も画面内に収める必要があり、そのぶん彼女がパネルより低くなっていました。いまその余白はパネルの上端より外側へはみ出します。画面内に収める対象は彼女の体で、しぐさが通る余白は画面の外へ出てかまいません。`,
      `高さが足りない場合にも対応しました。以前はウィンドウの高さが 640px を下回ると彼女が消えていましたが、これはレールの上に重なってしまうからという理由だけでした。自分の列を持ったいまは重なる相手がいないので、隠す必要がありません。`,
      { kind: 'heading', text: `質問を送っても、おすすめの質問が消えなくなりました` },
      `以前は質問を送った瞬間、レールがおすすめの質問をしまい、代わりに検索の進捗を表示していました。`,
      `これはおすすめの質問そのものの問題ではありません。彼女がレールの足元に立っていたため、おすすめの質問と進捗を両方出すと、進捗の最後の数ステップが彼女の頭で隠れてしまうのです。`,
      `彼女が移動したことで、この制約はなくなりました。いまは両方がレールを共有してスクロールするので、続けて質問するのに回答が終わるのを待つ必要はありません。`,
    ],
  },
  {
    id: 'hero-particle-field',
    date: '2026-08-14',
    title: `ヒーローが顔を手放し、中心から広がるパーティクルへ`,
    tags: ['design', 'technical'],
    body: [
      `ポイントクラウドの肖像がサイト最上部から姿を消しました。残ったのは見出しの一文と、画面の中心から外へ広がっていく粒子の場です。ページは読み込み演出もクリックすべきゲートもなく、そのまま本編から始まります。`,
      { kind: 'heading', text: `イントロも一緒に消えた理由` },
      `ローダー、Enter ゲート、映画的なイントロは、どれもあの顔のために存在していました。ゲートは重いダウンロードを覆い隠しつつタップの中で音声を解錠するためのもの、イントロは顔の上で演じられる演出、静止画は WebGL が使えない環境の代役です。顔がなくなれば三つとも役目を失うので、ヒーローはマウント即描画になり、見出しは最初の描画から表示されます。あわせて画像・音声・3D アセット **3.3MB** をサイトから外しました。`,
      { kind: 'heading', text: `動きの作り直し` },
      {
        kind: 'list',
        items: [
          `粒子はかつて頭部メッシュの頂点で生まれ、左右へ剥がれていきました。あの形は頭があって初めて成立します。今はどの粒子も中心から出発してまっすぐ外へ進むので、画面のどこを見ても一点から広がる動きに見えます。`,
          `中心からの距離は粒子の年齢から導いています。以前は速度を毎フレーム積み上げていたため、最初のフレームは中央の点にすぎず、広がりきるまで生涯ぶんの時間がかかりました。導出に変えたことで、最初の描画からすでに落ち着いた場が出ます。`,
          `方向は面積で標本化しています。すべての角度に同じ数の粒子を配ると、横長の画面では上下の短い辺が四隅の約 3 倍の密度になります。`,
          `どこまで進むかは、その粒子自身の方向でフレーム端までを測って決めます。近い辺へ向かう粒子が生涯の大半を画面外で費やすことはもうありません。`,
        ],
      },
    ],
  },
  {
    ...
    body: [
      `デビューの翌日、**Mika** は演技を覚えました。口の動きは音節ごとに音声へぴったり合い、顔には本物の感情がのり、声で挨拶し、お辞儀で見送ります。カメラも寄せて、その細部がちゃんと見える距離になりました。あわせてダウンロードサイズも **64% 軽く**なりました。`,
      ...
      { kind: 'heading', text: `演技する顔と身体` },
      {
        ...
        items: [
          ...
          `ジェスチャーも語彙に加わりました。質問にうなずき、チャットを閉じるとお辞儀します。`,
      ...
      `この演技はこれまで、高さ約 27px の顔の上で起きていました。スマートフォンでは約 19px です。カメラは腰から上を切り取る構図になり、顔は **1.7 倍**に。ページ上で彼女が占める面積はそのままなので、ほかの要素は動かす必要がありませんでした。チャットを開くとさらに大きくなり、キャンバス自体が広がってネイティブ解像度で描かれます。パネル表示でも全画面でも同じです。下端の切れ目はグラデーションでページにやわらかく溶けます。フレームは腕の長さにも合わせました。背伸びの指先はキャンバスの端で切れていたので、3 つの配置それぞれに横方向の余白を足しています。視野角は垂直基準なので、この余白は見た目の大きさを一切変えません。`,
      { kind: 'heading', text: `頭をなでる` },
      `頭の上を何度か往復してなでても、チャットが開いているときに頭を軽くタップしても、うれしそうに小さく頭を揺らして、照れたように笑います。三回続けると、笑い声はひとことの文句に変わります。ご覧になっている言語で話します。放っておくと、およそ 5 秒ごとに 16 種類の小さなしぐさからランダムにひとつ披露します。8 種は数秒とめて見せるポーズで、両手でピース、顔の横で片手ピース、自分のほっぺをつつく、敬礼、こちらを指さす、頭の後ろで手を組む、片手を腰に当てる、腰に手を当てたまま手を振る。残りの 8 種は、首かしげ、あたりを見回す、手のひらを眺める、重心移動、小さなバウンス、髪に触れる、腰ひねり、足元をのぞき込む、です。`,
  ...
  },
  {
    ...
    tags: ['feature', 'design', 'technical'],
    body: [
      `右下の AI アシスタントに顔と身体、そして名前がつきました。**ミカ（Mika）**、全身の **3D キャラクター**そのものが起動ボタンで、スマートフォンでもデスクトップでも表示されます。会話の状態にリアルタイムで反応します。何もないときは辺りを見回し、入力を始めた瞬間から下書きを追うように顔を上下に動かし、回答がストリーミングされる間は母音の口形で口が動き、全身の色調がサイトの mars orange へ暖かく変わって、回答が終わるとゆっくり元に戻ります。スマートフォンより広いウィンドウの全画面モードでは対話の隣に立ち、パイプラインのステーションが順に点灯するのを横目に回答を「読み上げ」ます。`,
      ...
      { kind: 'heading', text: `コストと、免除される訪問者` },
      {
        ...
        items: [
          ...
          `声もつきました。25 の日本語ショートフレーズ（VOICEVOX:春日部つむぎ）が 9 つの瞬間をカバーします。初回オープンの自己紹介、タップへの挨拶、質問送信への相づち、フルスクリーン移行、おすすめ質問の選択、クローズ時のお別れ、回答完了の締め、エラー時の一言、そして三回続けて頭をなでられたときの文句です。さらに、はじめの二回のなでに応える照れ笑いが 3 つあります。話しているあいだは口も動きます（回答時と同じ口形ループで、音声解析はしません）。音声は最初のタップからそのまま鳴ります（サイト全体の BGM スイッチは同時に廃止しました）。彼女が出す音はいつも訪問者の操作への返事で、勝手に鳴り出すことはありません。英語版サイトでは同じ声がカタカナ英語で話します。日本語なまりは意図的なチャームポイントです。笑い声は言葉を含まないので、どの言語版でも同じ 3 つが鳴ります。訪問して最初にチャットを開いたときだけフルの自己紹介をして、その後は短いフレーズに戻ります。`,
        ],
      },
