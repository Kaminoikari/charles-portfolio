...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      `デビューの翌日、**Mika** は演技を覚えました。口の動きは音節ごとに音声へぴったり合い、顔には本物の感情がのり、手を振って挨拶し、お辞儀で見送り、カーソルにも気づきます。あわせてダウンロードサイズも **64% 軽く**なりました。`,
      ...
      { kind: 'heading', text: `あなたに気づく` },
      `デスクトップでは、カーソルが近づくと視線で追いかけ、離れるといつもの見回しに戻ります。頭の上を何度か往復してなでると、うれしそうに小さく頭を揺らします（静かに。声を出すのは実際にタップしたときだけ）。放っておくと、およそ 10 秒ごとに 11 種類の小さなしぐさからランダムにひとつ披露します。伸び、首かしげ、あたりを見回す、手のひらを眺める、重心移動、小さなバウンス、腕の揺らし、髪に触れる、深呼吸、腰ひねり、足元をのぞき込む、のどれかです。`,
