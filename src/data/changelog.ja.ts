...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `頭の上を何度か往復してなでると、うれしそうに小さく頭を揺らします（静かに。声を出すのは実際にタップしたときだけ）。放っておくと、およそ 5 秒ごとに 18 種類の小さなしぐさからランダムにひとつ披露します。両手でピース、顔の横で片手ピース、自分のほっぺをつつく、敬礼、こちらを指さす、頭の後ろで手を組む、片手を腰に当てる、腰に手を当てたまま手を振る。残りの 10 種は、首かしげ、あたりを見回す、手のひらを眺める、重心移動、小さなバウンス、腕の揺らし、髪に触れる、深呼吸、腰ひねり、足元をのぞき込む、です。`,
