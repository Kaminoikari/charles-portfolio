    ...
    body: [
      ...
      { kind: 'heading', text: `コストと、免除される訪問者` },
      {
        ...
        items: [
          ...
          `声もつきました。23 の日本語ショートフレーズ（VOICEVOX:春日部つむぎ、クレジットはフッターに記載）が 7 つの瞬間をカバーします。タップへの挨拶、質問送信への相づち、フルスクリーン移行、おすすめ質問の選択、クローズ時のお別れ、回答完了の締め、エラー時の一言です。話しているあいだは口も動きます（回答時と同じ口形ループで、音声解析はしません）。音声は最初のタップからそのまま鳴ります（サイト全体の BGM スイッチは同時に廃止しました）。再生されるのは訪問者自身のタップの中だけで、勝手に鳴り出すことはありません。英語版サイトでは同じ声がカタカナ英語で話します。日本語なまりは意図的なチャームポイントです。`,
        ],
      },
