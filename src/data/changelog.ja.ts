...
export const changelog: ChangelogEntry[] = [
  {
    ...
    tags: ['feature', 'design'],
    body: [
      `ミカにはずっと二つの話し方がありました。タップしたとき、質問を送ったとき、パネルを全画面にしたときに聞こえるのは、元気いっぱいの女の子です。「Charles のことなら、あたしが世界で一番くわしいよ！」ところが文章で答えるときの口調は完全に中立で、しかも「Charles のポートフォリオアシスタントです」と名乗っていました。同じキャラクターなのに、しゃべるときと書くときで別人だったわけです。`,
      ...
      `三つの言語それぞれに、見分けのつく目印を決めました。中国語は文末の語気助詞と繰り返し、日本語は常体と冒頭の感動詞、英語は短縮形と一文一節。この基準で冒頭文 164 本と結びの一文 171 本を書き直し、あいだの内容は一文字も動かしていません。`,
      { kind: 'heading', text: `二度と壊れないようにする` },
      `以上はすべてテストで固定し、直した箇所をひとつずつ再び壊して、そのテストが本当に赤くなることを確認しました。テストのコメントが引用している数字自体も assert にしてあるので、古くなった数字はビルドを落とします。次に読む人を誤解させたまま残りません。`,
      {
        kind: 'stats',
        items: [
