...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      `二つ目は文体です。最初は「説明は敬体で着地させるもの」と判断し、彼女自身の冒頭文まで敬体で書いてしまい、その一文だけ礼儀正しい別人のように読めていました。収録台詞は各言語 25 本、すべて常体なので、今のルールはこうです。彼女自身の最初と最後の一文は必ず常体、あいだの説明は敬体のまま、文体の切り替わりは「彼女が話し終えて資料が始まる」位置にぴったり落ちる。読む人が感じ取れる線です。`,
      ...
      `三つの言語それぞれに、見分けのつく目印を決めました。中国語は文末の語気助詞と繰り返し、日本語は常体と冒頭の感動詞、英語は短縮形と一文一節。この基準で冒頭文 155 本と結びの一文 171 本を書き直し、あいだの内容は一文字も動かしていません。`,
      { kind: 'heading', text: `二度と壊れないようにする` },
      `以上を十五のテストで固定し、直した箇所をひとつずつ再び壊して、合計二十七の変異それぞれでテストが本当に赤くなることを確認しました。`,
      {
        kind: 'stats',
        items: [
