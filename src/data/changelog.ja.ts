...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      'サイト隅の「AI とチャット」ボタンを押すと、私が一から設計・構築したチャットボットが開きます。英語・中国語・日本語で私の仕事について答え、私の実際のポートフォリオデータのみに基づくので、作り話はしません。ChatGPT の薄いラッパーではなく、実際に動く AI エンジニアリング作品として作りました。',
