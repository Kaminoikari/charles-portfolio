...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `表示領域はチャットパネルの高さそのものになり、幅も同じ比率で広がるので、しぐさに必要な左右の余白は拡大後も残ります。`,
      `構図は変えておらず、腰から上のまま、全体が **1.64 倍**になっただけです。`,
      `パネルの高さと彼女の高さは、コード上で同じ数値を読みます。今後パネルを高くすれば彼女も一緒に伸びるので、置き去りになることはありません。`,
      ...
      `サイズは二つの数値のうち小さいほうを採ります。パネルの高さか、ウィンドウの幅で許される高さかです。比率は固定なので、狭いウィンドウでは同じ位置に一回り小さいミカが立ち、しぐさはすべてフレームに収まったままです。`,
