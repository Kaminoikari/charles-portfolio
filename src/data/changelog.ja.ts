...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      `二つ目は文体です。日本語のあいさつは常体でよくても、説明は敬体で着地させる必要があります。最初、常体の冒頭文を敬体の本文の前にそのまま貼ってしまい、ひとつの段落で二回切り替わって、また別人に読めていました。`,
      { kind: 'heading', text: `二度と壊れないようにする` },
      `以上を十一のテストで固定し、直した箇所をひとつずつ再び壊して、テストが本当に赤くなることを確認しました。`,
      {
        kind: 'stats',
        items: [
