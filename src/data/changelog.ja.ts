...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `サイズは三つの数値のうち最も小さいものを採ります。パネルの高さ、ウィンドウの幅で許される高さ、そしてウィンドウ自体が許せる高さです。三つめは、上げた手のために空けてある余白を画面の中に収めておくためのものです。比率は固定なので、狭いウィンドウでも背の低いウィンドウでも同じ位置に一回り小さいミカが立ち、しぐさはすべてフレームに収まったままです。`,
