...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      `右下の AI アシスタントに顔と身体がつきました。全身の **3D キャラクター**が起動ボタンの上に立ち、スマートフォンでもデスクトップでも表示されます。会話の状態にリアルタイムで反応します。何もないときは辺りを見回し、入力を始めた瞬間から下書きを追うように顔を上下に動かし、回答がストリーミングされる間は母音の口形で口が動き、全身の色調がサイトの mars orange へ暖かく変わって、回答が終わるとゆっくり元に戻ります。`,
      ...
      { kind: 'heading', text: `コストと、免除される訪問者` },
      {
        ...
        items: [
          ...
          `アクセシブルな本物のボタンはカプセルのまま（focus ring、aria-label、キーボード操作は不変）。キャラクターは装飾で、クリックしても開けます。`,
          `スマートフォンでは起動ボタンの上に立ち、チャットパネルが狭い画面を覆っている間は完全に退場して描画も止まります。`,
        ],
      },
