    ...
    body: [
      ...
      { kind: 'heading', text: `コストと、免除される訪問者` },
      {
        ...
        items: [
          ...
          `声もつきました。24 の日本語ショートフレーズ（VOICEVOX:春日部つむぎ）が 8 つの瞬間をカバーします。初回オープンの自己紹介、タップへの挨拶、質問送信への相づち、フルスクリーン移行、おすすめ質問の選択、クローズ時のお別れ、回答完了の締め、エラー時の一言です。さらに、頭をなでたときの照れ笑いが 5 つあります。話しているあいだは口も動きます（回答時と同じ口形ループで、音声解析はしません）。音声は最初のタップからそのまま鳴ります（サイト全体の BGM スイッチは同時に廃止しました）。彼女が出す音はいつも訪問者の操作への返事で、勝手に鳴り出すことはありません。英語版サイトでは同じ声がカタカナ英語で話します。日本語なまりは意図的なチャームポイントです。笑い声は言葉を含まないので、どの言語版でも同じ 5 つが鳴ります。訪問して最初にチャットを開いたときだけフルの自己紹介をして、その後は短いフレーズに戻ります。`,
        ],
      },
