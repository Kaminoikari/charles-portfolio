...
export const experience: ExperienceItem[] = [
  {
    ...
    bullets: [
      'USPACE app owner leading a 15-person cross-functional Scrum team (PM, dev, design) across TW + JP: drove product strategy across parking payments, corporate travel & insurance, doubling release velocity',
