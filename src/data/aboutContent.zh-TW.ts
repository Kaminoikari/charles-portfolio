...
export const aboutContent: AboutContent = {
  whoIAm: [
    '我是陳德潁（Charles Chen），台灣的 AI Product Manager。擅長從 0 到 1 打造軟體產品，結合產品策略與 AI 開發工具，從概念到上線端到端交付。',
    '過去 5 年的產品經歷橫跨創作者工具、金融科技、SaaS、MaaS，累計影響超過 600 萬使用者。目前在 USPACE 主導三條產品線（停車支付、企業差旅、金融保險）的策略，涵蓋台灣與日本市場，驅動公司 85% 以上的營收。',
    '我相信未來最好的產品經理會是 Product Builder：不只規劃產品，更能親手用 AI 工具快速做原型、上線驗證。這種方式讓我比傳統 PM 工作流快 5 倍迭代。',
  ],
  philosophyBullets: [
    {
