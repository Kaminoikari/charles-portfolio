...
export const projectDetails: ProjectDetail[] = [
  ...
  },
  {
    ...
    techStack: [
      ...
      { category: 'Data', items: 'FinMind API (Taiwan stock data), Redis caching' },
  ...
  },
  {
    ...
    solution: [
      'Built an AI agent as a Claude Code skill that orchestrates multiple product frameworks into a single spec generation pipeline. Users describe their product idea in one line, select an execution mode, and the agent produces a complete spec document.',
      'The key architecture decision was using 22 established product frameworks (JTBD, Persona, RICE, PRD, etc.) as structured prompts rather than free-form generation. Each framework constrains the AI\'s output to match how experienced PMs actually think.',
      'Designed 6 execution modes from lightweight (quick validation) to comprehensive (full spec with dev handoff). This lets PMs match the tool\'s depth to their stage — you don\'t need a 50-page spec for a feature experiment.',
      'The automated dev handoff translates product requirements into technical tasks with acceptance criteria, reducing the PM → engineer communication gap.',
    ],
    techStack: [
      { category: 'Platform', items: 'Claude Code Skill (TypeScript)' },
      { category: 'AI', items: 'Claude (Anthropic) — LLM orchestration' },
      { category: 'Frameworks', items: '22 product frameworks (JTBD, Persona, RICE, PRD, etc.)' },
      { category: 'Distribution', items: 'npm package, GitHub' },
    ],
    impact: [
      'Open source AI agent product used by product managers and developers',
      'Concept to complete spec in minutes instead of days',
      '22 product frameworks codified into reusable LLM prompts',
      '6 execution modes for different product development stages',
    ],
    learnings: [
