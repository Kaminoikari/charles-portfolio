...
export const projectDetails: ProjectDetail[] = [
  {
    ...
    impact: [
      ...
      'Offline-first architecture, so itineraries stay accessible without internet',
      'Under 2-minute onboarding to first complete itinerary',
      'Demonstrated full product lifecycle: research → design → build → ship',
    ],
    learnings: [
      'Offline-first sounds simple but requires careful state management. Conflict resolution between local and remote data was the hardest engineering problem, and I solved it with last-write-wins and timestamp-based merging.',
  ...
  },
  {
    ...
    solution: [
      ...
      'Added a prediction tracking system that logs every AI recommendation and tracks its accuracy over time. This builds user trust through transparency, so users can see exactly how often the AI\'s picks performed well.',
    ...
    learnings: [
      ...
      'Building a subscription SaaS taught me the importance of clear tier differentiation. The first version had too many features in the free tier, so users had no reason to upgrade. Restructuring around analysis depth (basic → advanced → deep) increased upgrade intent.',
    ],
    links: [
  ...
  },
  {
    ...
    impact: [
      ...
      'Multi-channel distribution across Claude.ai, Claude Code Plugin, and Claude Code Skill, meeting users inside their existing workflow',
    ],
    learnings: [
