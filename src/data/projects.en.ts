...
export const projects: Project[] = [
  {
    ...
    title: 'Path',
    description:
      'Offline-first trip planning PWA. Cache-first + background sync — your itinerary, transit routes, and costs stay reachable even when the network drops abroad.',
    ctaText: 'TRY IT',
