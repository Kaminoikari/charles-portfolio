...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'A free, open-source tool Charles built that gives an AI the instincts of a seasoned product manager. Tell it what you want to achieve, and it thinks your rough idea through the way a senior PM would, hands back a plan an engineer can actually build, and keeps the AI honest once the building starts.',
    ctaText: 'EXPLORE',
...
export const projectDetails: ProjectDetail[] = [
  ...
  {
    id: 'product-playbook',
    title: 'Product Playbook — An AI Product-Manager Partner for Claude Code',
    subtitle: '"Give an AI the instincts of a senior product manager, and let it do the hard thinking with you." Turning a rough idea into a plan an engineer can build usually takes a senior PM days of work. Now you just say the goal, and Product Playbook does that thinking for you. Here is how it works:',
    features: [
      { label: 'Say the goal, get the right thinking', description: 'You describe what you want to achieve, and it picks the right product-management method for the job, combining a few when a decision needs more than one angle, so you never have to know which framework to reach for yourself.' },
      { label: 'Specialist helpers for the hard calls', description: 'For the trickiest moments it brings in two focused helpers that work on their own: one plays devil\'s advocate to poke holes in the strategy, and the other\'s whole job is to imagine how the product could fail.' },
      { label: 'Shows its thinking, backs it with facts', description: 'Every answer notes which methods it leaned on, and when a call hangs on real-world facts it looks them up and cites the source.' },
      { label: 'A plan an engineer can build from', description: 'In one pass it produces a proper product spec with a security checklist built in, and can export it as a document, PDF, or slide deck ready to hand off.' },
      { label: 'Stays disciplined once you build', description: 'When you move from planning to writing code, it holds itself to good engineering habits: writing tests first, reviewing its own work, and not cutting corners before anything ships.' },
    ],
