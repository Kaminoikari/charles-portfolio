...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `Her size is the smallest of three numbers: the height of the panel, the height the window's width can afford, and the height the window itself can afford, which keeps the space held for a raised hand on screen. The ratio is fixed, so a narrow or a short window gets a smaller Mika in the same place, with every gesture still inside the frame.`,
