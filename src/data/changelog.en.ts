...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      `The first version of her lines were all short, all first person, and all passing their tests, and they still read wrong: the grammar was written prose, where every one of her recordings is speech. "This is my favorite one to answer, because his track record is dense" is an essay. What she says in her recordings is "Nobody knows Charles better than me!" So the standard became the recordings themselves: those 25 lines per language are the only place this character has actually been heard, and text that does not match them is a different character.`,
      `Each language got the marker that separates the two. Chinese lands on a sentence-final particle and reduplicates the way speech does; Japanese uses plain form and opens on an interjection; English contracts everything and stops after one clause. 155 opening lines and 171 closing lines were rewritten to that standard, and not one word of the content between them moved.`,
      { kind: 'heading', text: `Keeping it from breaking again` },
      `Fifteen tests now pin all of this down, and we broke each fix again one at a time, twenty-seven mutations in all, to confirm the tests actually turn red.`,
      {
        kind: 'stats',
        items: [
