...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      'It uses RAG (retrieval-augmented generation): instead of relying on what a language model "remembers", it first looks up the relevant facts from my portfolio, then writes an answer grounded in them. Mine is a "corrective" RAG — it checks its own work:',
      {
        kind: 'list',
        items: [
      ...
      { kind: 'heading', text: 'Built to run cheaply — most questions never call a paid model' },
      {
        ...
        items: [
          ...
          '**Answer cache** — about 50 common questions have pre-written answers (in all 3 languages). When a visitor asks something similar, the matching answer is returned directly — no language model is called at all. Only genuinely new questions go through the full pipeline.',
