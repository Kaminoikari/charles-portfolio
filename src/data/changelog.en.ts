...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `Her display area is now exactly the height of the chat panel, and its width scales with it, so the sideways room her gestures need survives the enlargement.`,
      `The framing is unchanged, still waist-up, just **1.64× larger** overall.`,
      `The panel height and her height read the same number in the code, so if the panel is ever made taller, she grows with it.`,
      ...
      `Her size is the smaller of two numbers: the height of the panel, or the height the window's width can afford. The ratio is fixed, so a narrow window gets a smaller Mika in the same place, with every gesture still inside the frame.`,
