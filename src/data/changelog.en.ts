...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `Stroke the top of her head a few times and she does a happy little head wiggle (silently; she only speaks when you actually tap her). Leave her alone and roughly every five seconds she picks one of eighteen little self-performances: a double peace sign, a single one beside her head, a poke at her own cheek, a salute, a point straight at you, hands behind her head, a hand on her hip, or that hand on her hip while the other waves. The quieter ten are a curious head tilt, a glance around, checking her palm, shifting her weight, a tiny bounce, swinging her arms, touching her hair, a deep breath, a hip twist, and peering at the floor.`,
