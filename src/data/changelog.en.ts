...
export const changelog: ChangelogEntry[] = [
  {
    ...
    body: [
      ...
      `The laughter is untouched: the three head-pat giggles carry no language, so all three sites still play the same files. The third pat in a row is the exception, because a complaint is words, and she now has one in each language.`,
    ],
  },
  {
