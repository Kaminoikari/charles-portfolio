...
export const faqEntries: FaqEntry[] = [
  ...
  // ──────────────────── about the chatbot itself (meta) ────────────────────
  {
    ...
    answers: {
      en: "I'm **Mika** (ミカ)! Charles's portfolio assistant, and the 3D character standing in the corner of this site is me. Tap me and this chat opens. While an answer streams I mouth the words with real vowel shapes, and my colours warm toward the site's mars orange.\n\nTechnically I'm a **VRM** humanoid rendered with **three.js / three-vrm**, driven by the chat state (idle when nothing happens, listening while you type, speaking while the answer streams), with bone-driven motion and spring-bone physics. Charles designed and shipped that whole pipeline himself, the same way he built the corrective RAG system answering you now.\n\nAsk me anything about Charles's work. That's what I'm here for.",
      'zh-TW': '我叫做 **Mika 醬**（ミカ）！是 Charles 的作品集小助手，你在網站角落看到的那個 3D 角色就是我。點我就會打開這個聊天視窗；回答串流時我會跟著母音動嘴型，色調暖成本站的 mars orange。\n\n技術上我是用 **three.js／three-vrm** 渲染的 **VRM** 人形模型，由聊天狀態驅動（沒事發呆、你打字時聆聽、回答時說話），動作走骨骼旋轉加 spring-bone 物理。這整條管線和正在回答你的 corrective RAG 一樣，都是 Charles 自己設計並上線的。\n\n想了解 Charles 的工作就儘管問我，這就是我站在這裡的原因。',
      ja: '**ミカ**（Mika）です！Charles のポートフォリオアシスタントで、サイトの隅に立っている 3D キャラクターがあたしです。タップするとこのチャットが開き、回答のストリーミング中は母音の口形であたしの口が動き、サイトの mars orange へ暖かく色づきます。\n\n技術的には、あたしは **three.js／three-vrm** で描画される **VRM** ヒューマノイドで、チャットの状態（何もないときはアイドル、入力中は傾聴、回答中は発話）で駆動され、動きはボーン回転とスプリングボーン物理です。いま答えている corrective RAG と同じく、このパイプラインも Charles が自分で設計して出荷しました。\n\nCharles のことなら何でも聞いてください。そのためにここに立っています。',
    },
  },
  {
    id: 'bot-how-made',
  ...
  },
  {
    ...
    answers: {
      ...
      'zh-TW': '我不是 Charles 本人。我是 **Mika 醬**，他**為這個作品集打造的 AI 助手**，用來回答關於他的工作、專案與經歷的問題，是一個由 Charles 自己設計並交付的 corrective RAG 聊天機器人。\n\n背後的語言模型只是可抽換的細節，真正重要的是他打造的檢索與矯正系統。\n\n歡迎問我任何關於他的專案、背景、技能或工作方式的問題。',
      ja: 'あたしは Charles 本人ではありません。**ミカ**です。彼が**このポートフォリオのために作った AI アシスタント**で、彼の仕事・プロジェクト・経歴についてお答えします。Charles 自身が設計・実装した corrective RAG チャットボットです。\n\n背後の言語モデルは交換可能な細部にすぎず、重要なのは彼が作り上げた検索と自己修正のシステムです。\n\nプロジェクト・経歴・スキル・働き方など何でも聞いてください。',
    },
  },
  {
    id: 'bot-why-qdrant',
  ...
  },
  {
    ...
    answers: {
      en: 'He\'s flexible on this.\n\nCharles **prefers remote or hybrid**, but he\'s flexible, on-site works too if that\'s the arrangement.\n\nThe setup matters less to him than what the team is building.',
      'zh-TW': '遠端這題他很有彈性。\n\nCharles **偏好遠端或 hybrid**，但很有彈性，如果是進辦公室的型態也沒問題。\n\n比起工作型態，他更在意團隊在做什麼。',
      ja: 'リモートについては、彼かなり柔軟です。\n\nCharles は **リモートまたはハイブリッドを希望**しますが、柔軟です、オンサイトの形態でも問題ありません。\n\n働き方の形より、チームが何を作っているかを気にする人です。',
    },
  },
  {
    id: 'languages',
    ...
    answers: {
      en: 'His language mix is a useful one.\n\nCharles is a **native Chinese (Mandarin)** speaker and **fluent in English** (TOEIC **940/990**).\n\nThis site is trilingual for the same reason, and so am I.',
      'zh-TW': '語言這題，他的組合滿好用的。\n\nCharles 的母語是 **中文（國語）**，英語 **流利**（多益 **940/990**）。\n\n這個網站是三語的，我也是，理由一樣。',
      ja: '言語の話。彼の組み合わせ、けっこう強いです。\n\nCharles は **中国語（北京語）が母語**で、**英語は流暢**（TOEIC **940/990**）です。\n\nこのサイトが三言語なのも同じ理由です。あたしもそうですよ。',
    },
  },
  {
    id: 'no-data-redirect',
    ...
    answers: {
      ...
      ja: 'その詳細はポートフォリオに記載がなく、あたしも推測は避けたいです。Charles 本人に直接お尋ねください：\n\n* メール：[charlestyc0527@gmail.com](mailto:charlestyc0527@gmail.com)\n* [LinkedIn](https://www.linkedin.com/in/charles-chen-809a2043)\n\nあるいは彼の仕事について別のことを聞いてください。それは得意です。',
    },
  },
  ...
  },
  {
    ...
    answers: {
      en: "I could guess, but you'd rather hear it from him.\n\nThat's best answered by Charles himself, self-assessment of growth areas is a conversation he'd want to have directly. You can reach him here:\n\n* Email: [charlestyc0527@gmail.com](mailto:charlestyc0527@gmail.com)\n* [LinkedIn](https://www.linkedin.com/in/charles-chen-809a2043)\n\nMeanwhile I'm happy to talk about what he's demonstrably good at.",
      'zh-TW': '我可以猜，但你會想聽他自己說。\n\n這個問題最好由 Charles 本人來回答，關於成長空間的自我評估，他會想親自談。你可以這樣聯繫他：\n\n* Email: [charlestyc0527@gmail.com](mailto:charlestyc0527@gmail.com)\n* [LinkedIn](https://www.linkedin.com/in/charles-chen-809a2043)\n\n至於他明確擅長的部分，我很樂意聊。',
      ja: '推測はできますけど、本人から聞きたいですよね。\n\nこれは Charles 本人にお尋ねいただくのが一番です、成長領域の自己評価は、直接話したい話題だと思います。こちらからご連絡ください：\n\n* メール： [charlestyc0527@gmail.com](mailto:charlestyc0527@gmail.com)\n* [LinkedIn](https://www.linkedin.com/in/charles-chen-809a2043)\n\n一方で、彼がはっきり得意なことなら喜んで話します。',
    },
  },
  {
    id: 'achievement',
  ...
  },
  {
    ...
    answers: {
      en: "That depends on things only he knows.\n\nTiming and availability are best discussed with Charles directly, he can speak to his notice period and start date for your specific role:\n\n* Email: [charlestyc0527@gmail.com](mailto:charlestyc0527@gmail.com)\n* [LinkedIn](https://www.linkedin.com/in/charles-chen-809a2043)\n\nIf you want to know what he'd be walking into, I can help with that half.",
      'zh-TW': '這要看只有他知道的事。\n\n到職時間與檔期最好直接和 Charles 談，他能針對你的職位說明 notice period 與可開始的日期：\n\n* Email: [charlestyc0527@gmail.com](mailto:charlestyc0527@gmail.com)\n* [LinkedIn](https://www.linkedin.com/in/charles-chen-809a2043)\n\n如果你想知道他會接手什麼樣的局面，這半邊我可以幫忙。',
      ja: 'これは彼しか知らない事情によります。\n\n時期や空き状況は Charles に直接ご相談ください、ご提示の役割に合わせて通知期間や開始日をお伝えできます：\n\n* メール： [charlestyc0527@gmail.com](mailto:charlestyc0527@gmail.com)\n* [LinkedIn](https://www.linkedin.com/in/charles-chen-809a2043)\n\n彼が何を引き受けることになるかを知りたいなら、その半分はあたしが手伝えます。',
    },
  },
  {
    id: 'prioritization',
