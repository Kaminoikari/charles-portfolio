...
export const faqEntries: FaqEntry[] = [
  ...
  // ──────────────────── about the chatbot itself (meta) ────────────────────
  {
    ...
    answers: {
      en: "I'm **Mika** (ミカ)! Charles's portfolio assistant, and the full-body 3D character standing in the corner of this site is me. Tap me and this chat opens. While an answer streams I mouth the words with real vowel shapes, and my colours warm toward the site's mars orange.\n\nTechnically I'm a **VRM** humanoid rendered with **three.js / three-vrm**, driven by the chat state (idle when nothing happens, listening while you type, speaking while the answer streams), with bone-driven motion and spring-bone physics. Charles designed and shipped that whole pipeline himself, the same way he built the corrective RAG system answering you now.\n\nAsk me anything about Charles's work. That's what I'm here for.",
      'zh-TW': '我叫做 **Mika 醬**（ミカ）！是 Charles 的作品集小助手，你在網站角落看到的那個全身 3D 角色就是我。點我就會打開這個聊天視窗；回答串流時我會跟著母音動嘴型，全身色調暖成本站的 mars orange。\n\n技術上我是用 **three.js／three-vrm** 渲染的 **VRM** 人形模型，由聊天狀態驅動（沒事發呆、你打字時聆聽、回答時說話），動作走骨骼旋轉加 spring-bone 物理。這整條管線和正在回答你的 corrective RAG 一樣，都是 Charles 自己設計並上線的。\n\n想了解 Charles 的工作就儘管問我，這就是我站在這裡的原因。',
      ja: '**ミカ**（Mika）です！Charles のポートフォリオアシスタントで、サイトの隅に立っている全身 3D キャラクターが私です。タップするとこのチャットが開き、回答のストリーミング中は母音の口形で私の口が動き、全身がサイトの mars orange へ暖かく色づきます。\n\n技術的には、私は **three.js／three-vrm** で描画される **VRM** ヒューマノイドで、チャットの状態（何もないときはアイドル、入力中は傾聴、回答中は発話）で駆動され、動きはボーン回転とスプリングボーン物理です。いま答えている corrective RAG と同じく、このパイプラインも Charles が自分で設計して出荷しました。\n\nCharles のことなら何でも聞いてください。そのためにここに立っています。',
    },
  },
  {
    id: 'bot-how-made',
  ...
  },
  {
    ...
    answers: {
      ...
      ja: '私は Charles 本人ではありません。**ミカ**です。彼が**このポートフォリオのために作った AI アシスタント**で、彼の仕事・プロジェクト・経歴についてお答えします。Charles 自身が設計・実装した corrective RAG チャットボットです。\n\n背後の言語モデルは交換可能な細部にすぎず、重要なのは彼が作り上げた検索と自己修正のシステムです。\n\nプロジェクト・経歴・スキル・働き方など何でも聞いてください。',
    },
  },
  {
    id: 'bot-why-qdrant',
